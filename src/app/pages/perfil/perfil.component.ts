...
export class PerfilComponent implements OnInit {
  ...
  public usuario: Usuario = this._usuarioService.usuario;
  public imagenSubir!: File;
  public imgTemp: any = null;

  constructor( private fb: FormBuilder, private _usuarioService: UsuarioService, private _fileUploadService: FileUploadService) {
